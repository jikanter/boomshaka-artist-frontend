...
class Boom_MediaUpload { 
  ...
  function __construct($name, $type, $postid, $bits, $create_product = false, $product_fields = array()) { 
    $this->name = $name;
    $this->type = $type;
    $this->bits = $bits;
    $this->overwrite = true;
    ...
    if ($this->create_product) { 
      $this->productp = $this->productize_media($this->product_fields);
    }
  }
