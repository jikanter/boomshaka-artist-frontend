...
$document_root  = "/Users/admin/Sites/2014/7/21/tests/test-adaptive";
$requested_uri  = parse_url(urldecode("/flowers.jpg"), PHP_URL_PATH);
...
if (!file_exists($source_file)) {
  ...
  var_dump("source_file: " . $source_file);
  exit();
}
